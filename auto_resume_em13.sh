...
CHECKPOINT_DIR="logs/prism-qwen25-dinosiglip-224px+0_5b+mx-roboverse+n1+b32+x7/checkpoints"
...
run_training_with_monitoring() {
    ...
    local BASE_CMD="torchrun --standalone --nnodes 1 --nproc-per-node 4 vla-scripts/train.py \
        --vla.type 'prism-qwen25-dinosiglip-224px+0_5b+mx-roboverse' \
        --data_root_dir data/1.0.0 \
        --run_root_dir logs/ \
        --run_id prism-qwen25-dinosiglip-224px+0_5b+mx-roboverse+n1+b32+x7 \
