...
@dataclass
class Exp_Qwen25_DinoSigLIP_224px_0_5B_ROBOVERSE(Exp_Qwen25_DinoSigLIP_224px_0_5B_OXE_Magic_Soup):
    vla_id: str = "prism-qwen25-dinosiglip-224px+0_5b+mx-roboverse"

    data_mix: str = "roboverse"
...
class VLARegistry(Enum):
    ...
    Qwen25_DinoSigLIP_224px_0_5B_ROBOVERSE=Exp_Qwen25_DinoSigLIP_224px_0_5B_ROBOVERSE
